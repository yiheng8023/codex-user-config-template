...
Use native reasoning with the global meta-guidance. A private configuration may
...
orchestration. A default private bootstrap should install the global meta-guidance alone;
